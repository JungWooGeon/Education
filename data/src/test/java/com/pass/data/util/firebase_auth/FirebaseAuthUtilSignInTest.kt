...
class FirebaseAuthUtilSignInTest {
    ...
    fun testSuccessSignIn() = runBlocking {
        ...
        val result = firebaseAuthUtil.signIn(testId, testPassword).first()
