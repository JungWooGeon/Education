...
class FirebaseDatabaseUtilReadIdList {
    ...
    private val firebaseDatabaseUtil = FirebaseDatabaseUtil(mockFirebaseAuth, mockFirebaseFireStore)
    ...
    fun testSuccessReadIdList() = runBlocking {
        ...
        val result = firebaseDatabaseUtil.readIdList(userIdList = testIdList).first()
